...
export function SubtitleEditor() {
    const {cues, reorderCues, transcriptionStatus, transcriptionError} = useSubtitleStore()
    ...
    return (
        <div
            className={`flex flex-col gap-2 w-1/3 h-full ${isError ? 'opacity-50 pointer-events-none select-none' : ''}`}>
